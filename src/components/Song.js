...
const Song = ({song, index}) => {
	...
	return (
		<div className="flex items-center w-full">
			...
			<span className="w-1/3 flex items-center mr-8 flex-1">
			...
			<span className="text-grey-300 text-sm w-1/5 whitespace-nowrap overflow-hidden overflow-ellipsis text-sm mr-8 flex-1">{song.track.album.name}</span>
